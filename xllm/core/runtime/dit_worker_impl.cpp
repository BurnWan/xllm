...
DiTCacheConfig parse_dit_cache_from_flags() {
  ...
  if (::xllm::DiTConfig::get_instance().dit_cache_policy() == "FBCache") {
    ...
    cache_config.regione.skip_interval_steps =
        ::xllm::DiTConfig::get_instance().dit_regione_skip_interval_steps();
    ...
    cache_config.regione.kv_cache_mode =
        ::xllm::DiTConfig::get_instance().dit_regione_kv_cache_mode();
    cache_config.regione.kv_async_prefetch =
        ::xllm::DiTConfig::get_instance().dit_regione_kv_async_prefetch();
    cache_config.regione.kv_cpu_pinned =
        ::xllm::DiTConfig::get_instance().dit_regione_kv_cpu_pinned();
